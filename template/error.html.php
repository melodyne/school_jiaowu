...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area">
        <h2 class="weui-msg__title"><?echo $msg;?></h2>
        <p class="weui-msg__desc">系统检测到您的帐号或密码已变更</p>
    </div>
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            <a href="<?php echo url('bind',urlencode(get_present_url()));?>" class="weui-btn weui-btn_default">重新绑定</a>
        </p>
    </div>
